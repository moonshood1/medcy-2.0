...
function Carousel() {
  return (
    <section className="w-full mt-0.5 px-1">
      <OwlCarousel
        className="owl-theme"
        responsive={{
          0: {
      ...
      >
        <div className="relative">
          ...
          <div className="absolute left-0  md:top-40 px-10 py-2 h-1/2 bg-medBlue opacity-80">
            <p className="mt-2 md:text-6xl font-bold text-white opacity-100 tracking-wide">
              Le soulagement d'accéder <br /> à un medecin, en quelques minutes{" "}
              <br />
              sans se déplacer
            </p>
            <button className="btn mt-5 md:mt-32 bg-white text-medBlue">
              Prendre un RDV
            </button>
          </div>
        </div>
        ...
        <div className="relative backdrop-contrast-100">
          ...
          <div className="absolute left-0  md:top-40  px-10 py-2 h-1/2 bg-medBlue opacity-80">
            ...
            <button className="btn hidden md:flex md:mt-32  bg-white text-medBlue">
              Prendre un RDV
            </button>
          </div>
        </div>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 text-white gap-0">
        <div className="px-2 bg-gray-800 pb-3">
          <h1 className="text-3xl md:text-5xl font-bold mt-3">
            L’automédication Facilite la Mort
          </h1>
          ...
          <button className="btn bg-medBlue text-white mt-5 md:mt-32">
            Prendre un RDV
          </button>
        </div>
        <div>
